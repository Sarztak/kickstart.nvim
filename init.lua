  ...
  settings = {
    Lua = {
      ...
      workspace = {
        ...
        library = { vim.env.VIMRUNTIME }, -- just VIMRUNTIME, not all runtime files
      },
...
-- Don't auto insert comment on Enter or o/O
...
-- autosave
-- pattern = '*' means apply to all files
-- silent! suppresses errors, and write saves the file
